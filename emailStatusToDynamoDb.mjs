...
const tableName = process.env.DYNAMO_DBTABLE
 
const dynamoDBRegion = process.env.AWS_REGION
 
const dynamoDbClient = new DynamoDBClient({ region: dynamoDBRegion });
 
// const dynamoDbClient = new DynamoDBClient({ region: dynamoDBRegion});
 
const saveRecordItemToDynamoDB = async (itemData) => {
...
export default saveRecordItemToDynamoDB;